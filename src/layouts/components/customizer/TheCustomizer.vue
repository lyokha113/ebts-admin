            ...
            <div class="mt-4">
              ...
              <div>
                ...
                <vs-radio class="mr-4" v-model="theme" vs-value="dark"
                  >Dark</vs-radio
                >
                <vs-radio v-model="theme" vs-value="semi-dark"
                  >Semi Dark</vs-radio
                >
              </div>
            </div>
            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio
                  ...
                  vs-value="navbar-hidden"
                  >Hidden</vs-radio
                >
                <vs-radio
                  class="mr-4"
                  v-model="navbarTypeLocal"
                  vs-value="navbar-static"
                  >Static</vs-radio
                >
                <vs-radio
                  class="mr-4"
                  v-model="navbarTypeLocal"
                  vs-value="navbar-sticky"
                  >Sticky</vs-radio
                >
                <vs-radio v-model="navbarTypeLocal" vs-value="navbar-floating"
                  >Floating</vs-radio
                >
              </div>
            </div>
            ...
            <div class="mt-4">
              ...
              <div>
                ...
                <vs-radio
                  ...
                  >Static</vs-radio
                >
                <vs-radio v-model="footerTypeLocal" vs-value="sticky"
                  >Sticky</vs-radio
                >
              </div>
            </div>
